...
<html lang="en">
    ...
    <body>
        ...
        <h2 class="header1">Tambah Data Mahasiswa</h2>
        <form method="post" action="simpan.php">
            <table>
                <tr><td class="tanda">NIM</td><td><input type="text" onkeyup="isi_otomatis()" name="nim"></td></tr>
                <tr><td class="tanda">NAMA</td><td><input type="text" name="nama"></td></tr>
                <tr><td class="tanda">JENIS KELAMIN</td><td>
                    <input type="radio" name="jenis_kelamin" value="L">Laki-laki
                    <input type="radio" name="jenis_kelamin" value="P">Perempuan
                </td></tr>
                <tr><td class="tanda">JURUSAN</td><td>
